...
urlpatterns = [
    ...
    path('addlecture/<str:room_name>/<str:semester>/<str:year>', views.addlecture, name='addlecture'),
    ...
    path('quizmaker/<int:pk_classroom>', views.quizmaker, name="quizmaker"),
    path('createquizprocess/<int:pk_classroom>', views.createquizprocess),
